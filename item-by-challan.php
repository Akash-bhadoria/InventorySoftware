                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-success" style="background-color: green"
                                        ...
                                        <a class="btn btn-success" style="background-color: red"
                                            ...
                                            href="item-by-challan.php?issue_id=<?php echo $result->issued_id; ?>&challan_id=<?php echo $challan_id; ?>&vendor_name=<?php echo $vendor_name; ?>&date=<?php echo $date; ?>">DELETE</a>
                                    </td>
                                </tr>
                                <?php $cnt++;} }?>
                            </tbody>
