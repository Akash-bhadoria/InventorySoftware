                                                ...
                                                <div class="col m12">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col  s12">
                                                            <select name="item_name" id="item_name" autocomplete="off" required>
                                                    ...
                                                    <button type="submit" name="add" id="add" class="waves-effect waves-light btn indigo m-b-xs">SAVE</button>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="item-from-company-edit.php?id=<?php echo htmlentities($result->id); ?>"><i class="material-icons">mode_edit</i></a>
                                                    <a href="item-from-company.php?del=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you want to delete');"> <i class="material-icons" style="color:red">delete_forever</i></a>
                                                </td>
                                            </tr>
                                    <?php $cnt++;
                                        }
