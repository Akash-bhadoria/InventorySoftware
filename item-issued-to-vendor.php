...
if (strlen($_SESSION['emplogin']) == 0) {
    ...
    if ($query->rowCount() > 0) {
        foreach ($results as $result) {
            $challan_count = $result->challan_no ?? "15000";
        }
    }
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-success" style="background-color: blue" target="_blank"
                                        ...
                                        <a class="btn btn-success" style="background-color: orange" target="_blank"
                                            href="print-receipt.php?challan_id=<?php echo $result->challan_issued ?>&vendor_name=<?php echo $result->vendor_name ?>&date=<?php echo $result->date_issued ?>">PRINT RECEIPT</a>
