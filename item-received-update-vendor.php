                            ...
                            <div class="row">
                                <form class="col s12" name="chngpwd" method="post">
                                    <?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong> :
                                            <?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>SUCCESS</strong> :
                                    ...
                                    ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="input-field col m6 s12">
                                                    <input id="item_name" type="text" class="validate" autocomplete="off" name="item_name" value="<?php echo htmlentities($result->item_name); ?>" readonly>
                                                    <label class="active" for="item_name">Item Name</label>
                                                </div>
                                                <div class="input-field col m6 s12">
                                                    <input id="quantity_issued" type="number" class="validate" autocomplete="off" name="quantity_issued" value="<?php echo htmlentities($result->quantity_issued); ?>" readonly>
                                                    <label class="active" for="quantity_issued">Quantity Issued</label>
                                                </div>
                                                <div class="input-field col m6 s12">
                                                    <input id="date_issued" type="date" class="validate" autocomplete="off" name="date_issued" value="<?php echo htmlentities($result->date_issued); ?>" readonly>
                                                    <label class="active" for="date_issued">Date Issued</label>
                                                </div>
                                                <div class="input-field col m6 s12">
                                                    <input id="challan_issued" type="text" class="validate" autocomplete="off" name="challan_issued" value="<?php echo htmlentities($result->challan_issued); ?>" readonly>
                                                    <label class="active" for="challan_issued">Challan Issued</label>
                                                </div>
                                                <div class="input-field col m6 s12">
                                                    <input id="vendor_issued" type="text" class="validate" autocomplete="off" name="vendor_issued" value="<?php echo htmlentities($result->vendor_name); ?>" readonly>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-content row">
                                                            ...
                                                            <div class="input-field col  s12">
                                                                <input id="quantity_issued" type="text" class="validate" autocomplete="off" name="quantity_issued" value="<?php echo htmlentities($result->total_item_left); ?>" readonly>
                                                                <label class="active" for="quantity_issued">Total Item Left To
                                                                    Vendor</label>
                                                            </div>
                                                            <div class="input-field col  s12">
                                                                <input id="quantity_received" type="number" class="validate" autocomplete="off" min="0" name="quantity_received">
                                                                <label class="active" for="quantity_received">Item Received From
                                                                    Vendor</label>
                                                            </div>
                                                            <div class="input-field col  s12">
                                                                <input id="defective_received" type="number" class="validate" autocomplete="off" min="0" name="defective_received">
